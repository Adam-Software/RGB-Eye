...
void set_color(uint8_t color, uint8_t state){
	switch (color){
		case RED :{
			switch (state) {
				case ON:{U1_registers[5] = U1_registers[5] & 0b11111011;
				break;}
				case OFF:{U1_registers[5] = U1_registers[5] |  0b00000100;
				break;}
			}
			break;
		}
		case GREEN :{
			switch (state) {
				case ON:{U1_registers[5] = U1_registers[5] & 0b11110111;
				break;}
				case OFF:{U1_registers[5] = U1_registers[5] | 0b00001000;
				break;}
			}
			break;
		}
		case BLUE :{
			switch (state) {
				case ON:{U1_registers[5] = U1_registers[5] & 0b11101111;
				break;}
				case OFF:{U1_registers[5] = U1_registers[5] | 0b00010000;
				break;}
			}
			break;
		}
				...
				case RB_COLOR :{
					switch (state) {
						...
						break;}
						case OFF:{
							U1_registers[5] = U1_registers[5] | 0b00000100;
